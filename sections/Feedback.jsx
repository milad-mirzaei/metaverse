...
const Feedback = () => (
  <section className={`${styles.paddings} relative z-10 `} >
    ...
    >
      ...
      className='flex-[.5] lg:max-w-[370px] flex justify-end flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[3px] border-gray-50 relative'
      >
        ...
        <p className=" mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading[45px] leading-[39px] text-white  " >
          With th development of today's
          technpology, metaverse is very useful for
